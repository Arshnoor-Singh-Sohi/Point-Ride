# Generated by Django 5.2.4 on 2025-07-04 21:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_photos', models.JSONField(blank=True, default=list, null=True)),
                ('availability', models.JSONField(blank=True, default=dict, null=True)),
                ('account_status', models.CharField(choices=[('PENDING', 'Pending Verification'), ('VERIFIED', 'Verified'), ('REJECTED', 'Rejected')], default='PENDING', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='traveller_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
